...
import { vietnamProvinces } from '../lib/provinces';
import { Calendar, MapPin, Shield, DollarSign, MousePointerClick, Headphones, Tag } from 'lucide-react';
...
export function Home() {
  ...
  const handleSearch = () => {
    ...
    navigate('/routes', {
      state: { startProvince, destinationProvince, travelDate, numberOfTickets }
    });
  };
  ...
  return (
    <Layout>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="space-y-2">
                    <Label htmlFor="start" className="flex items-center gap-2">
                      ...
                      {t('home.startProvince')}
                    </Label>
                    <Select value={startProvince} onValueChange={setStartProvince}>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="destination" className="flex items-center gap-2">
                      <MapPin className="size-4" />
                      {t('home.destinationProvince')}
                    </Label>
                    <Select value={destinationProvince} onValueChange={setDestinationProvince}>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="tickets">{t('home.numberOfTickets')}</Label>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="mb-4">{t('home.promotions')}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription>
                  Get 20% discount on your first bus ticket booking. Valid for all routes.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription>
                  Upgrade to premium seats with extra legroom and amenities at no extra cost.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription>
                  Earn points with every booking and redeem for free tickets and upgrades.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="mb-4">{t('home.whyChooseUs')}</h2>
          </div>
